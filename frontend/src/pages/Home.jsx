...
//       <div className="relative flex flex-col md:flex-row items-center justify-between gap-12 px-6 py-16 max-w-6xl mx-auto text-white">
...
{/* Left Side Text */}
        <div className="flex flex-col text-center md:text-left max-w-xl">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Study Smarter, Dream Bigger ✨
          </h2>
          <p className="text-lg md:text-xl text-gray-200">
            Unlock scholarships, explore top universities, and begin your journey abroad with ease 🚀
          </p>
        </div>
